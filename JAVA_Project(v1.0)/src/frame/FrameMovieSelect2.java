		   ...
		   public FrameMovieSelect2() {
		      ...
		      btnMovie5.addActionListener(new ActionListener() {
		         ...
		         public void actionPerformed(ActionEvent e) {
		            ...
		            FrameBase.getInstance(new FrameMovieInfo(movie5)); //객체만들기
		         }
		      });
		      ...
		      btnMovie6.addActionListener(new ActionListener() {
		         ...
		         public void actionPerformed(ActionEvent e) {
		            ...
		            FrameBase.getInstance(new FrameMovieInfo(movie6)); //객체만들기
		         }
		      });
		      ...
		      btnMovie7.addActionListener(new ActionListener() {
		         ...
		         public void actionPerformed(ActionEvent e) {
		            ...
		            FrameBase.getInstance(new FrameMovieInfo(movie7)); //객체만들기
		         }
		      });
		      ...
		      btnMovie8.addActionListener(new ActionListener() {
		         ...
		         public void actionPerformed(ActionEvent e) {
		            ...
		            FrameBase.getInstance(new FrameMovieInfo(movie8)); //객체만들기
		         }
		      });
		      ...
		      //하단의 버튼 설정
		       JPanel bottomSet = new JPanel();
		         ...
		         btnBack.addActionListener(new ActionListener() {//이전 버튼을 누르면 뒤로가!
		         ...
		         btnHome.addActionListener(new ActionListener() {
		            ...
		            @Override
		            public void actionPerformed(ActionEvent e) {
		               FrameBase.getInstance(new FrameBegin());//처음 화면으로 가!
		            }
		         });
